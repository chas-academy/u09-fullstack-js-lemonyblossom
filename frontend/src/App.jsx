...
function App() {
  ...
  return (
    <Router>
      <div className="App relative inset-x-0 mx-auto overflow-y-auto flex items-center justify-start max-w-[600px] h-screen font-sans bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-500 ">
