...
function App() {
  ...
  return (
    <Router>
      <div className="App fixed inset-x-0 mx-auto flex items-center justify-center max-w-[600px] h-screen font-sans bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-500 overflow-y-auto">
