...
const Tools = () => {
   ...
   return (
      <div className="flex flex-col items-center justify-start min-h-screen w-screen md:max-w-[600px] lg:[1200px] bg-gradient-to-br from-purple-600 via-indigo-500 to-blue-500 py-10 scrollbar-none">
