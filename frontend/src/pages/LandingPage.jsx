         ...
         <div className="flex flex-col items-center space-y-4">
            <Link to="/tools">
               <div className="relative group">
                  ...
                  />
                  {/* Overlay effect */}
                  <div className="absolute inset-0 bg-white bg-opacity-10 rounded-xl opacity-0 transition-opacity duration-500 ease-out group-hover:opacity-100" />
               </div>
            </Link>
            <p className="text-gray-300 text-lg animate-fadeInUp opacity-0 animation-delay-3">
               Learn regulating tools and skills!
            </p>
         </div>
